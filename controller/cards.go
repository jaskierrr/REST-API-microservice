...
func (c controller) GetCardID(ctx context.Context, id string) (models.Card, error) {
...
func (c controller) DeleteCardID(ctx context.Context, id string) (pgconn.CommandTag, error) {
